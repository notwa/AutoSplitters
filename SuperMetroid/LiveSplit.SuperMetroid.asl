...
init
{
    ...
    if (memory.ProcessName.ToLower().Contains("snes9x")) {
        ...
        var versions = new Dictionary<int, long>{
            ...
            { 9158656, 0x907BC4 },    // snes9x 1.61
            { 12955648, 0x140883158 },// snes9x 1.61 (x64)
            { 24072192, 0x16C0E40 },  // snes9x 1.62
            { 29069312, 0x141758D40 },// snes9x 1.62 (x64)
            { 10399744, 0x9B74D0 },   // snes9x 1.62.2/1.62.3
            { 15474688, 0x140A62390 },// snes9x 1.62.2/1.62.3 (x64)
